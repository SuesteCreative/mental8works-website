document.addEventListener('DOMContentLoaded', () => {
    ...
    if (menuToggle && navLinks) {
        menuToggle.addEventListener('click', () => {
            ...
            // Toggle icon between Menu and X (simple text change or SVG swap if simple)
            // Since we use SVGs in HTML, we might need a simpler approach or direct SVG manipulation.
            // For this static version, I'll rely on the CSS 'open' state, 
            // but let's add a visual cue or rotation if possible.
            const icon = menuToggle.innerHTML;
    ...
    document.querySelectorAll('.animate-fade-up').forEach(el => {
        // el.style.opacity = '0'; // Ensure hidden initially if CSS doesn't handle it
        observer.observe(el);
    });
});
